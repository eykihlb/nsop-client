...
import com.mydao.nsop.client.exception.NSOPClientException;
...
public class Sequence {
    ...
    public Sequence(long workerId, long datacenterId) {
        if (workerId > maxWorkerId || workerId < 0) {
            throw new NSOPClientException(String.format("worker Id can't be greater than %d or less than 0", maxWorkerId));
        }
        if (datacenterId > maxDatacenterId || datacenterId < 0) {
            throw new NSOPClientException(
